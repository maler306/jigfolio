...
class StudiosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create studio" do
    assert_difference('Studio.count') do
      post studios_url, params: { studio: { budget: @studio.budget, location_id: @studio.location_id, name: @studio.name, user_id: @studio.user_id } }
    end
  ...
  test "should update studio" do
    patch studio_url(@studio), params: { studio: { budget: @studio.budget, location_id: @studio.location_id, name: @studio.name, user_id: @studio.user_id } }
